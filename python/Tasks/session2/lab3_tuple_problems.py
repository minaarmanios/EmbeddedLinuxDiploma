...
def tuple_operations(tuple1, tuple2):
    ...
    """
    res = {"concatenation":None,"repetition":None}
    # Write your solution here
    if isinstance(tuple1,tuple) and isinstance(tuple2,tuple):
        res["concatenation"] = tuple1 + tuple2
        res["repetition"] = tuple1 * 2
    elif isinstance(tuple1,tuple):
        res["concatenation"] = tuple1
        res["repetition"] = tuple1
    elif isinstance(tuple2,tuple):
        res["concatenation"] = tuple2
        res["repetition"] = tuple2
    return res
